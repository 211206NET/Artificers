...
public class StoredQA {
    ...
    if(this.canSet == true)
    {
        ...
        k=35;
        this.q[k,0] = "In Shell Script, what is the syntax read the user input and store to a string?"; 
        ...
        k=36;
        this.q[k,0] = "In Shell Script, what is the syntax check the value of a string in a condition?"; 
        ...
        k=37;
        this.q[k,0] = "In Shell Script, what is the syntax store a random number 0 to 100?"; 
        ...
        k=38;
        this.q[k,0] = "In Shell Script, what is the syntax write a while loop?"; 
        ...
        k=49;
        this.q[k,0] = "In Shell Script, what do you type into your code treat unset variables as errors and exit?"; 
        ...
        this.q[k,2] = "Current Variations System: maintains a several copies of source code to record all changes"; 
        this.q[k,3] = "Cloud Version Syntax: Used to keep each contributer's code seperated from the rest."; 
        this.q[k,4] = "Consumer Value Store: also stands for \"Convenience, Value, and Service\"";
        k=59;
        this.q[k,0] = "What does DCVS mean?"; 
        ...
        this.q[k,3] = "Dynamic Cloud Version Syntax: Used to keep each contributer's code seperated from the rest."; 
        this.q[k,4] = "Destination Cloud Variation System: allows users to work without the need for local files";
        k=60;
